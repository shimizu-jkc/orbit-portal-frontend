...
例えば、[BDR](/guide/common/glossary#dr-design-review)承認済みの基本計画書などを本番環境の払い出し申請の際に添付してください。
...
尚、ルートユーザーのEメールアドレスは[「SSOポータル」](/guide/aws/id-management#ssoポータル)から確認することができます。
