...
OrBITでは、AWSアカウントの払い出しをプロジェクトに替わって行うことで、プロジェクトの作業工数を削減します。また、そのアカウントを組織的に管理することで、全社的にガバナンスを効かせることができます。
...
> 詳細については、[「セキュリティエスカレーション」](/guide/aws/monitoring#セキュリティエスカレーション)を参照してください。
...
例えば、BDR承認済みの基本計画書などを本番環境の払い出し申請の際に添付してください。
...
:::
::: warning ATTENTION
プロジェクトアカウントの払い出しには、最大で5営業日程度かかる場合があることに注意してください。
:::
...
SSOポータルについては、[「SSOポータルとは？」](/guide/aws/id-management#ssoポータル)を参照して下さい。
...
詳細については、[「ベースライン」](/guide/aws/baseline)を参照して下さい。
...
尚、ルートユーザーのEメールアドレスは[「SSOポータル」](/guide/aws/id-management#プロジェクトアカウントへのアクセス手段)から確認することができます。
...
詳細については、[「一括請求による支払いと社内配賦」](/guide/aws/billing#一括請求による支払いと社内配賦)を参照してください。
:::
