...
*1 OrBIT運用チームでは、インシデントの発生時に要因の調査や解析を支援することがあるため、すべてのプロジェクトに対して`SecurityAuditorAccess`を持ちます。詳細は[「セキュリティエスカレーション」](/aws/guide/monitoring#セキュリティエスカレーション)をご覧ください。
