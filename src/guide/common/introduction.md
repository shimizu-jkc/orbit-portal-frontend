...
また、共通サービスやプラットフォームも同様であり、今後の開発については[ロードマップ](/guide/common/roadmap.html)をご覧ください。
:::
...
- [「AWSにおけるベースラインのリソース一覧」](/guide/aws/reference/baseline.html#リソース一覧)

### 2. OrBITカタログシステム
カタログとは、私たちが支援してきた様々な案件から得た知見や技術を、汎用的かつ簡単に利用することができるようにしたモノです。
> カタログの詳細に関しては、[「カタログとは？」](/knowledge/introduction.html)を参照してください。
